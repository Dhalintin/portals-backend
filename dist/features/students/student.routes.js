...
studentRoutes.get("/", (0, authorize_1.authorize)("school_admin", "teacher", "exam_officer"), (0, validate_1.validate)({ query: student_dto_1.listStudentsQuerySchema }), student_controller_1.studentController.list);
...
studentRoutes.get("/:id", (0, authorize_1.authorize)("school_admin", "teacher", "exam_officer"), (0, validate_1.validate)({ params: student_dto_1.studentIdParamsSchema }), student_controller_1.studentController.getById);
